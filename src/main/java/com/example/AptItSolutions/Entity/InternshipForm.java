...
public class InternshipForm {
		...
		public InternshipForm(String intRegId, String name, String email, String mobile, String collegename,
				String collegeid, String country, String state, String city, String choosedomain, String timeduration,
				String anyquiries, byte[] certificates) {
			super();
			this.intRegId = intRegId;
			this.name = name;
			this.email = email;
		...
		public String toString() {
			return "InternshipForm [intRegId=" + intRegId + ", name=" + name + ", email=" + email + ", mobile=" + mobile
