...
public class InternshipController {
    ...
    public ResponseEntity<?> saveInternshipForm(
        ...
        try {
            // Create an InternshipForm object and set its properties
            ...
            // Convert and set the byte array from MultipartFile
            try {
            ...
            InternshipForm savedForm = internshipService.save(form);
            ...
            String userEmailContent = String.format(
                    ...
                    name, savedForm.getIntRegId(), name, email, mobile, choosedomain, timeduration, collegename, city);
...
//                  "sai.srinivas@aptits.com"
            ...
            response.put("proRegId", savedForm.getIntRegId());
    ...
    @GetMapping("/{id}")
    public InternshipForm getById(@PathVariable String id) {
        return internshipService.getById(id);
    }

    @DeleteMapping("/delete/{id}")
    public void deleteById(@PathVariable String id) {
        System.out.println("Deleting Internship with ID: " + id);
